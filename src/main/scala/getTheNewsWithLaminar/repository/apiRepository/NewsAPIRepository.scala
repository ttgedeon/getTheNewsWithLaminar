package getTheNewsWithLaminar.repository.apiRepository

import getTheNewsWithLaminar.domain.storageDomain.User
import getTheNewsWithLaminar.domain.apiDomain.Enumerations.Api
import getTheNewsWithLaminar.domain.storageDomain.NewsDb.ParamType
...
trait NewsAPIRepository[A]:
  ...
  /**
   * The endpoint that will be used for all fetch operations fo this repository
